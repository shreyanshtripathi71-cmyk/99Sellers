                           ...
                           {!style_2 ? (
                              <>
                                 <li className="d-flex align-items-center login-btn-one">
                                    {user ? (
                                       // LOGGED IN STATE
                                       <Link href="/dashboard/dashboard-index" className="fw-500 tran3s d-flex align-items-center">
                                 ...
                                 {/* Only show "Add Listing" or similar actions if user is allowed */}
                                 <li className="d-none d-md-inline-block ms-3 ms-xl-4 me-xl-4">
                                    <Link href="/search" className={style_1 ? "btn-ten" : "btn-two rounded-0"}>
                                       <span>Search Leads</span> <i className="fa-thin fa-arrow-up-right"></i>
                                    </Link>
                                 </li>
                              ...
                              // STYLE 2 (Alternative Layout) logic
                              <>
                                 <li className="d-none d-md-flex align-items-center login-btn-one me-4 me-xxl-5">
                                    <i className="fa-regular fa-phone-volume"></i>
                                    <Link href="tel:+210-0000-0000" className="tran3s">+1 (800) 99-SELLER</Link>
                                 </li>
                                 <li>
